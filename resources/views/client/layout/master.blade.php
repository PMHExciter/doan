                    ...
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="#"><img src="{{ asset('client/images/Banner_Vu_lan-01.jpg') }}"
                                        class="img-fluid" style="height: 386px;" width="900px"
                                        alt="First slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="{{ asset('client/images/Banner_KM_băng_đĩa_890x396px.jpg') }}"
                                        class="img-fluid" style="height: 386px;" width="900px"
                                        alt="Second slide"></a>
                            </div>
                            <div class="carousel-item">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            ...
                            <p class="detail">Tuyển chọn bởi BookStores</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="gioithieu">
                        <h3 class="header text-uppercase font-weight-bold">Về BookStore</h3>
                        <a href="#">Giới thiệu về BookStore</a>
                        <a href="#">Tuyển dụng</a>
                        {{-- <div class="fb-like" data-href="https://www.facebook.com/BookStore-110745443947730/"
